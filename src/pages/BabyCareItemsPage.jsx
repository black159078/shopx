...
const BabyCareItemsPage = ()=>{
    ...
    useEffect(()=>{
        axios
        .get("http://localhost:5000/api/category/babyandkid/babycareitems")
        .then(res=>{
                ...
                <div className="container-fluid">
                    <div className="row">
                        <div className="col-lg-10 col-md-9 ms-auto">
                            ...
                            <h5 className="display-6 text-center fw-bold">Available Babycare items</h5>
...
export default BabyCareItemsPage;