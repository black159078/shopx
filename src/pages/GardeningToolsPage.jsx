...
const GardeningToolsPage = ()=>{
    ...
    useEffect(()=>{
        axios
        .get("http://localhost:5000/api/category/gardening/gardeningtools")
        .then(res=>{
                ...
                <div className="container-fluid">
                    <div className="row">
                        <div className="col-lg-10 col-md-9 ms-auto">
                            ...
                            <h5 className="display-6 text-center fw-bold">Available Gardening Tools</h5>
...
export default GardeningToolsPage;