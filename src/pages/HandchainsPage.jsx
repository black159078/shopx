...
const HandchainsPage = ()=>{
    ...
    useEffect(()=>{
        axios
        .get("http://localhost:5000/api/category/jewellery/handchains")
        .then(res=>{
                ...
                <div className="container-fluid">
                    <div className="row">
                        <div className="col-lg-10 col-md-9 ms-auto">
                            ...
                            <h5 className="display-6 text-center fw-bold">Available Handchains</h5>
