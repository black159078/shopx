...
const JacketsPage = ()=>{
    ...
    useEffect(()=>{
        axios
        .get("http://localhost:5000/api/category/menfashion/jackets")
        .then(res=>{
                ...
                <div className="container-fluid">
                    <div className="row">
                        <div className="col-lg-10 col-md-9 ms-auto">
                            ...
                            <h5 className="display-6 text-center fw-bold">Available Jackets</h5>
                            
                            <div className="row g-2">
                                {datas.map((data,idx)=>(
                                    <div key={idx} className="col-lg-2 col-md-3 col-sm-4">
                                        <div className="card border-0 shadow h-100">
                                            <img src={data.image} className="card-img-top p-3" style={{height:"200px",objectFit:"center"}} />
