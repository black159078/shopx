...
const OtherElectronicsPage = ()=>{
    ...
    useEffect(()=>{
        axios
        .get("http://localhost:5000/api/category/electronic/electronicsupplies")
        .then(res=>{
                ...
                <div className="container-fluid">
                    <div className="row">
                        <div className="col-lg-10 col-md-9 ms-auto">
                            ...
                            <h5 className="display-6 text-center fw-bold">Available Other Electronic Accessories</h5>
...
export default OtherElectronicsPage;