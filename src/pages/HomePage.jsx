                                    ...
                                    <li className="nav-item fw-bold w-100">Categories</li>
                                    {
                                        categories.map((category,idx)=>(
                                            <li key={idx} className="nav-item text-dark opacity-90">{category.value ? (
                                                <>
                                                    <a href="javascript:void(0);" className="nav-link m-0 p-2 d-flex justify-content-between align-items-center fw-semibold hovereffect" data-bs-toggle="collapse" data-bs-target={`#category-${idx}`}><span><FontAwesomeIcon icon={category.icon} className="me-1" />{category.name}</span> <FontAwesomeIcon icon={faAngleLeft} className="ms-2" /></a>
                                                    <ul id={`category-${idx}`} className="collapse">
